...
public class HistogramEQ {
    ...
    public static void main (String[] params ){
        try {
            BufferedImage image = ImageIO.read(new File("data/bennevis.jpg"));
            BufferedImage eqimage =  HistogramEQ.computeHistogramEQ(image);
            ImageIO.write(eqimage,"jpg", new File("data/benneviseq.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
